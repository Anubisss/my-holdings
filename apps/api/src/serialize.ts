...
const toSecondary = (value: Big | string | null, fx: Fx): string | null => {
...
const toPrimary = (value: Big | string | null, fx: Fx): string | null => {
...
const sumCash = (rows: AccountRow[], pick: (row: AccountRow) => string | null): Big =>
